...
const GalleryPres = ({galleryModalActive, setGalleryModalActive}: Iprops) => {
  ...
  if(galleryModalActive){
    return <GalleryCarousel photos={photos} setGalleryModalActive={setGalleryModalActive}/>
  }
    ...
    <section className="Gallery">
      ...
      <section className="Gallery_container">
        ...
        <article className="Gallery_photo">
          <img src={photo1} alt="" onClick={()=> setGalleryModalActive(true)}/>
        </article>

        {/* Photo2 */}
        <article className="Gallery_photo">
          <img src={photo2} alt="" onClick={()=> setGalleryModalActive(true)}/>
        </article>

        {/* Photo3 */}

        <article className="Gallery_photo">
          <img src={photo3} alt="" onClick={()=> setGalleryModalActive(true)}/>
        </article>

        {/* Photo4 */}

        <article className="Gallery_photo">
          <img src={photo4} alt="" onClick={()=> setGalleryModalActive(true)}/>
        </article>

        {/* Photo5 */}

        <article className="Gallery_photo">
          <img src={photo5} alt="" onClick={()=> setGalleryModalActive(true)}/>
        </article>

        {/* Photo6 */}

        <article className="Gallery_photo">
          <img src={photo6} alt="" onClick={()=> setGalleryModalActive(true)}/>
        </article>

        {/* Photo7 */}

        <article className="Gallery_photo">
          <img src={photo7} alt="" onClick={()=> setGalleryModalActive(true)}/>
        </article>

        {/* Photo8 */}

        <article className="Gallery_photo">
          <img src={photo8} alt="" onClick={()=> setGalleryModalActive(true)}/>
        </article>
      </section>
    </section>
  );
